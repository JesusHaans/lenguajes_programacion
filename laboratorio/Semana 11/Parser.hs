...
happyExpList = Happy_Data_Array.listArray (0,70) ([18672,257,0,0,96,0,0,61440,328,5263,64,1024,0,128,2048,5632,65280,61460,328,5263,0,16384,0,7,0,18672,36609,61460,328,8288,1536,24576,2,0,5263,18672,24577,64,6,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","num","bool","var","'('","')'","'+'","'*'","if","then","else","lam","'='","let","in","end","%eof"]
